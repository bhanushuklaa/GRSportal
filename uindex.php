      ...
      <div class="overview-boxes">
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic"><u>My NPY Complains</u></div>
            ...
            <i class="fa-sharp fa-solid fa-envelopes-bulk fa-2xl"></i>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="text"><h1 style="text-align: center;"><?php
              ...
              $query="select count(status) from tbl_complain where uid='$uid'";
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic"><u>MY PENDING COMPLAINTS</u></div>
